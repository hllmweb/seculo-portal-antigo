    ...
    function frmnoticia() {
        switch ($this->input->get_post('acao')) {
            ...
            case 'U': // EDITA DADOS NO BANCO
                ...
                $data['cd_curso'] = $row['CD_CURSO'];
                $data['cd_serie'] = $row['ORDEM_SERIE'];
                ...
                $data['bt_cor'] = 'warning';
                $data['bt_acao'] = 'Editar';
                $data['curso'] = $this->colegio->sp_curso_serie_turma_aluno($par = array('operacao' => 'C'));
                $data['serie'] = $this->colegio->sp_curso_serie_turma_aluno($par = array('operacao' => 'S','curso'=>$row['CD_CURSO']));
                break;
    ...
    function frmnoticiamanter() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $parametro = array(
                ...
                'ordem_serie' => $this->input->get_post('serie')
            );

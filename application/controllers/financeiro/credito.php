...
class Credito extends CI_Controller {
    ...
    function index() {
        ...
        if(base64_decode($this->input->post('acao')) == 'extrato'){
            ...
            if($tipo == '1'){
                $t_e = $this->pagar->extrato_credito($r);
            }else{
                $t_e = $this->pagar->extrato_almoco($r);
            }
            ...
            if($tipo == '1'){
                ...
                $this->load->view('financeiro/credito/tela_almoco', $data);
            } 
    ...
    function limite() {
        ...
        $data = array(
            'titulo' => '<h1> Financeiro <i class="fa fa-angle-right"></i> Crédito para Aluno</h1>',
            'aluno' => $this->responsavel->acompanhamento(array('operacao' => 'FA', 

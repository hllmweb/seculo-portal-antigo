...
//        $this->load->model('professor/nota_model', 'nota', TRUE);
    ...
    function consultar() {
        ...
        $nota = $this->input->get('nota') . " - " . $bimestre . "° BIMESTRE";
        ...
        if ($this->input->get("mista") == 'S') {
         ...
         $num_nota = $this->input->get('numero');
        ...
        if($num_nota == 6){//6 = MBT
            ...
            //muda bimestre para o codigo da media na tabela
            switch ($bimestre) {
                case 1:
                    $bimestre = 7; //media total 1 bimestre
                    break;
                
                case 2:
                    $bimestre = 13; // 2 bimestre
                    break;

                case 3:
                    $bimestre = 21; // 3 bimestre
                    break;

                case 4:
                    $bimestre = 27; //4 bimestre
                    break;
            ...
            $alunos = $this->tipoNota->listaMediaBimestres($turma, $periodo, $disciplina, $bimestre);
        }
        else{
    ...
    function lancar_nota() {
       ...
       // set_msg('msgok', 'Lançamento Efetuado com sucesso', 'sucesso');
        ...
        //redirect(base_url('professor/nota/index'), 'refresh');
    }

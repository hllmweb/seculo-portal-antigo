...
class Inicio_model extends CI_Model {
    ...
    function sp_dashboard($parametro) {
        ...
        $params = array(
            ...
            array('name' => ':P_CURSO', 'value' => $this->session->userdata('SCL_SSS_USU_CURSO')),
            array('name' => ':P_ORDEM_SERIE', 'value' => $this->session->userdata('SCL_SSS_USU_SERIE')),
            array('name' => ':P_VISAO', 'value' => $this->session->userdata('SCL_SSS_USU_TIPO')), //*mm
            array('name' => ':P_CODIGO', 'value' => $this->session->userdata('SCL_SSS_USU_CODIGO')), //*mm
            array('name' => ':RC1', 'value' => $cursor, 'type' => OCI_B_CURSOR)
        );
        return $this->db->sp_seculo('BD_PORTAL', 'AES_DASHBOARD2', $params);
    }

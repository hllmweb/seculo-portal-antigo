...
class Infantil_model extends CI_Model {
    ...
    //foi adicionado parametro bimestre para o filtro 05-06-2019
    ...
    function diario_lancar($data) {
        ...
        if ($consulta->num_rows() == 0) {
            $sql = "INSERT INTO bd_sica.cl_acompanhamento_infantil( 
                                ...
                                obs_colacao, obs_almoco, obs_lanche, obs_descanso, obs_evacuacao
						 )VALUES(
						  '" . $data['aluno'] . "',
            ...
            $sql = "UPDATE bd_sica.cl_acompanhamento_infantil 
			           SET colacao = '" . $data['colacao'] . "',
                           ...
                           obs_colacao = '" .$data['obs_colacao']. "',
                           obs_almoco = '" .$data['obs_almoco']. "',
                           obs_lanche = '" .$data['obs_lanche']. "',
                           obs_descanso = '" .$data['obs_descanso']. "',
                           obs_evacuacao = '" .$data['obs_evacuacao']. "'
					 WHERE cd_aluno = '" . $data['aluno'] . "' AND dt_acompanhamento = trunc(sysdate)";

        }
        $query = $this->db->query($sql);
       // $result = $consulta->result_fetch();

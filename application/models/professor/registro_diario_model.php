...
class Registro_diario_model extends CI_Model {
    ...
    public function verificaCoordenacao($p){
        $query = $this->db->query("select a.cd_curso as pedagogico, t.cd_curso as extra, u.nm_usuario as professor, a.nm_aluno as aluno from bd_sica.aluno a 
        join bd_sica.turma t on t.cd_turma = '".$p['turma']."' and t.periodo = '".$p['periodo']."' and a.cd_aluno = ".$p['aluno']." JOIN bd_sica.usuarios u on u.cd_usuario = ".$p['professor']);

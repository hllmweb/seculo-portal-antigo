      ...
      /*
        $sql = " SELECT *
                    ...
                    SELECT DISTINCT
                           ...
                           NVL(CASE WHEN NVL(M.CD_MATERIAL_BAIXA,0) = 0
                                THEN (SELECT NVL(MA.QTDE_ESTOQUE,0)
                                       ...
                                       WHERE MA.CD_MATERIAL = M.CD_MATERIAL
                                         ...
                                         AND MA.CD_ALMOXARIFADO   IN(11,13))
                                ELSE (SELECT NVL(MA1.QTDE_ESTOQUE,0)
                                       ...
                                       WHERE MA1.CD_MATERIAL = M.CD_MATERIAL_BAIXA
                                         ...
                                         AND MA1.CD_ALMOXARIFADO IN(11,13) ) END,0) AS QTD_ESTOQUE,
                     ...
                     WHERE TP.ID_TERMINAL IN (SELECT ID_TERMINAL FROM BD_PDV.TERMINAIS WHERE CD_ALMOXARIFADO IN(11,13))
                       AND M.FLG_ATIVO = 'S'
                       AND M.FLG_VENDA = 'S'
                                ...
                                SELECT 
                                      ...
                                      M.CD_MATERIAL_BAIXA,
                                                           CASE WHEN NVL(M.CD_MATERIAL_BAIXA,0) <> 0
                                                                ...
                                                                ELSE 0 END AS CD_UNIDADE_MEDIDA_BAIXA      
                                FROM 
                                   BD_FINANCEIRO.EST_MATERIAL M
                                   INNER JOIN BD_FINANCEIRO.EST_NATUREZA  N ON N.CD_NATUREZA = M.CD_NATUREZA
                                WHERE FLG_VENDA = 'S'
                                AND M.FLG_ATIVO = 'S'
                                and m.preco_aluno = ".$dados['preco']."
                                AND EXISTS(select 1 from BD_FINANCEIRO.est_material_almoxarifado EST WHERE QTDE_ESTOQUE > 0 AND EST.CD_MATERIAL = M.CD_MATERIAL AND EST.CD_ALMOXARIFADO IN (11,13))

...
<div id="content">
            ...
            <div class="page-header media">
                <div class=" media">
                    <a class="pull-left">
                        ...
                        <img src="<?= "https://seculomanaus.com.br/portal/restrito/foto?codigo=" . $aluno['CD_ALUNO'] ?>" class="media-object">
                    </a>
    ...
    <div class="panel-group panel-group-acompanhamento">
        ...
        <?php } else { ?>
            ...
            <div class="panel panel-success">
                <a class="ajax" href="#infantil" data-url="#" data-parent=".panel-group-acompanhamento" data-toggle="collapse">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa fa-book"></i> Acompanhamento Infantil<i class="fa fa-angle-down pull-right"></i>
                        </h4>
                    </div>
                </a>

                <div class="panel-collapse collapse" id="infantil">
                    <div style="display: none" id="loading" class="text-center">
                        <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div class="panel-body">
                        <!-- <select id="bim_infantil" name="disciplina" class="form-control">
                        ...
                        site_url("impressao/questionario") . "?token=" . $token."&b=1"?>"
                        target="_blank"  >1 Bimestre</a>

                        <a class="btn btn-primary" href="<?=
                        site_url("impressao/questionario") . "?token=" . $token."&b=2"?>"
                        target="_blank"  >2 Bimestre</a>

                        <a class="btn btn-primary" href="<?=
                        site_url("impressao/questionario") . "?token=" . $token."&b=3"?>"
                        target="_blank"  >3 Bimestre</a>

                        <a class="btn btn-primary" href="<?=
                        site_url("impressao/questionario") . "?token=" . $token."&b=4"?>"
                        target="_blank"  >4 Bimestre</a>
                    </div>
                </div>
            </div>
        ...
        <div class="panel panel-danger">
            <a class="ajax" href="#registros-pedagogicos" data-url="<?= site_url("acompanhamento/registrosPedagogicos") . "?token=" . $token ?>" data-parent=".panel-group-acompanhamento" data-toggle="collapse">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="fa fa-exclamation-circle"></i> Registros Diários e Pedagógicos<i class="fa fa-angle-down pull-right"></i>
                    </h4>
                </div>
            </a>

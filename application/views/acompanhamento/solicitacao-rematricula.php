<table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
      <td align="center">
          <h4>Requerimento de Renovação de Matrícula para 2020.</h4>
      </td>
  </tr>
</table>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" style="font-size:12px">
  ...
  <tr>
      <td colspan="3" align="left" valign="top">
          ...
          2020 para cursar a <?=$proxima[0]['PROX_NM_SERIE']?> série do <?=$proxima[0]['PROX_NM_CURSO']?>. 
          <br/><br/>
          Informamos que este documento deverá ser assinado e devolvido a escola até o dia 30/12/2019, 
  ...
  <tr>
      <td colspan="3" height="100" align="center" valign="bottom">
          Manaus-AM, <?=date('d')?> de novembro de <?=date('Y')?>.<br/><br/><br/>

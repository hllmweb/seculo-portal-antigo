                    ...
                    <form id="form_pesq" name="form_pesq" method="post">
                        <div class="col-xs-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id ="tipo_e" type="radio" name="tipo" value="1" class="checkbox-inline" checked="checked">Crédito
                                <input id ="tipo_e"type="radio" name="tipo" value="2" class="checkbox-inline">Almoço

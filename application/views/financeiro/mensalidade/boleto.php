...
<table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      ...
      <div>-->
      <div class="texto">Linha Digitável: <?=$boleto['linhaDigitavel'] ?> </div>
      <div class="texto">Valor: R$ <?=number_format($boleto['valor_cobrado'],2,',','.')?></div>
      </td>
  </tr>
  <tr>
    <td>
      ...
      <table width="100%" border=0 align=center cellpadding=0 cellspacing=0 style="border-bottom:1px dotted #000000">
        <tr>
          <td width="1%" align="left"><img SRC="<?=SCL_RAIZ?>assets/images/logo.png" width="15%"></td>
          <td width=54%></td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0px; padding:0px">
        ...
        <tr>
          <td colspan="6" rowspan="2" valign="top" class="b_esquerda">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <?=$boleto['cedente_cnpj']?><br><?= $boleto['cedente_endereco']?></td>
          <td valign="top">
          	<div class="label">Agencia/Código Beneficiario</div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="7%" rowspan="2" align="center" class="b_esquerda"><div class="label">Espécie Doc.</div><?=$boleto['especie_doc']?></td>
        ...
        <tr>
          ...
          <td width="7%" rowspan="2" align="center" class="b_esquerda"><div class="label">Espécie</div><?php echo $boleto['especie']?></td>
        ...
        <tr>
          <td height="15" align="right" class="b_direita texto_direita"><?=number_format($boleto['valor_cobrado'],2,',','.'); #$boleto['valorBoleto']?></td>
        </tr>
        <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0px; padding:0px">
        ...
        <tr>
          <td colspan="7" class="b_direita">
         	<div class="label">Pagador</div>
			<div class="texto"><?=$boleto['sacado'].$boleto['sacado_cpf']?></div>
      <div class="texto"><?= $boleto['res_endereco'];?></div>
            <div class="label">Código da Baixa</div>
			<div class="texto"><?=$boleto['codigo_baixa']?></div>
          </td>
        </tr>

                                            ...
                                            ?>
                                                ...
                                                <td class="text-center" style="width: 3%">
                                                   ...
                                                   // if (empty($row['DT_BAIXA']) && $row['FLG_IMPRIME_SICANET'] = 1  && $row['NOSSO_NUMERO'] > 99999999 && $row['DT_ENVIADO'] != '') {
                                                     if (empty($row['DT_BAIXA']) && $row['DT_ENVIADO'] != '') {
                                                       ...
                                                       echo "<input name='aluno' type='hidden' id='aluno' value='" . $row['CD_ALUNO'] . "' />";
                                                        ...
                                                        //echo '<button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-credit-card"></i> Download Boleto</button>';
                                                        echo '<button type="submit" class="btn btn-success btn-xs">Visualizar Boleto</button>';
                                                        echo "</form>";

                                                        //echo "<a href='boleto/imprimir2?id=".$row['CD_ALUNO']."-".$row['CD_PRODUTO']."-".$row['MES_REFERENCIA']."-".$row['NUM_PARCELA']."-".$row['NR_ORDEM']."'>Ver</a>";
                                                    } elseif ($row['NFSE_NUMERO'] != '') {
                                                        echo '<a href="https://www.seculomanaus.com.br/portal/application/upload/aluno/' . $row['CD_ALUNO'] . '/Arquivos/Pagamentos/' . $row['NFSE_NUMERO'] . '.pdf" target="_blank"  > <i class="fa fa-download"></i> NFS-E</a>';
                                                    }
                                                    ?>
                    ...
                    <div class="tab-pane" id="messages">
                        <div class="well">                            
                            <table class="table table-hover" id="titulos_pagos" data-page-size="20" >
                                ...
                                <tbody>
                                    <?php
                                    //print_r($mensalidade);exit;

                                    foreach ($mensalidade as $row) {

                                        $getLink = explode(',', $row['NFSE_LINK']);
                                        

                                         if(count($getLink) > 1){

                                            $newLink = $getLink[0].','.$row['VALOR_RECEBIDO'].','.$getLink[2].','.$getLink[3];
                                        
                                         }else{

                                            $newLink = $row['NFSE_LINK'];
                                        ...
                                        if (!empty($row['DT_BAIXA'])) {
                                            ...
                                            <tr class="success">                                                                                       
                                                ...
                                                <td class="text-center" style="width: 10%">
                                                    ...
                                                    -->
                                                         <a href="<?=$newLink;?>" target="_blank" ><i class="fa fa-download"></i> NFS-E</a> 

                ...
                <tr>
                    ...
                    if (($row['GEMINADO'] && $row['QTDE_GEMINADO'] > 0) || !$row['GEMINADO']):
                        ...
                        <td class="text-center" <?= $rowspan ?> style="vertical-align: middle">
                            ...
                            <?php if  ($row['HR_ABERTURA'] == "" && $row['TIPO'] <> "F" && $row['TIPO'] <> "R" && $row['TIPO'] <> "P") : ?>
                                <a class="btn btn-primary" href="<?= site_url("professor/diario/abrir_aula?aula=" . $row['CD_CL_AULA']) ?>">
                                    Abrir Aula                        
                                </a>

                            <?php elseif (($row['ULTIMO_GEMINADO'] === null && $row['HR_FECHAMENTO'] == "" && $row['TIPO'] <> "F" && $row['TIPO'] <> "R" && $row['TIPO'] <> "P") || $row['ULTIMO_GEMINADO'] !== null && $row['ULTIMO_GEMINADO']['HR_FECHAMENTO'] == "" && $row['TIPO'] <> "F" && $row['TIPO'] <> "R" && $row['TIPO'] <> "P") : ?>
                            ...
                            <?php endif;?>
                                ...
                                &nbsp;&nbsp;                                
                                <a href="<?= site_url("professor/diario/fechar_aula?aula=" . $row['CD_CL_AULA']."&tipo=".$row['TIPO']) ?>" >

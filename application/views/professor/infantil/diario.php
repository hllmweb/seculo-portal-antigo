                    ...
                    foreach ($alunos as $row) {
                        ...
                        <tr>
                            ...
                            <td width="10%"  style="vertical-align:middle">
                                <select width="100%" name="colacao<?= $row['CD_ALUNO'] ?>" id="colacao<?= $row['CD_ALUNO'] ?>">
                                    <option value=""></option>
                                ...
                                <textarea name="obs_colacao<?= $row['CD_ALUNO'] ?>" id="obs_colacao<?= $row['CD_ALUNO'] ?>" placeholder="Observação colação..." maxlength="255"><?= $row['OBS_COLACAO'] ?></textarea>
                            </td>
                            <td width="10%"  style="vertical-align:middle">
                                ...
                                <textarea name="obs_almoco<?= $row['CD_ALUNO'] ?>" id="obs_almoco<?= $row['CD_ALUNO'] ?>" placeholder="Observação almoço..." maxlength="255"><?= $row['OBS_ALMOCO'] ?></textarea>
                            </td>
                            <td width="10%"  style="vertical-align:middle">
                                ...
                                <textarea name="obs_lanche<?= $row['CD_ALUNO'] ?>" id="obs_lanche<?= $row['CD_ALUNO']?>" placeholder="Observação lanche..." maxlength="255"><?= $row['OBS_LANCHE']; ?></textarea>
                            </td>
                            <td width="10%"  style="vertical-align:middle">
                            ...
                            ?> value="TQ">Tranquilo</option>
                                ...
                                <textarea name="obs_descanso<?= $row['CD_ALUNO']; ?>" id="obs_descanso<?= $row['CD_ALUNO']; ?>" placeholder="Observação sono/descanso..." maxlength="255"><?= $row['OBS_DESCANSO']; ?></textarea>
                            </td>
                            <td width="10%"  style="vertical-align:middle">
                                ...
                                <textarea name="obs_evacuacao<?= $row['CD_ALUNO']; ?>" id="obs_evacuacao<?= $row['CD_ALUNO']; ?>" placeholder="Observação evacuação..." maxlength="255"><?= $row['OBS_EVACUACAO']; ?></textarea>
                            </td>
                        </tr>
                <?php }  } ?>
            </tbody>

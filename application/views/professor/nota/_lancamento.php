                                            ...
                                            <tr>
                                                        ...
                                                        if ($v->CD_ALUNO == $row->CD_ALUNO) {
                                                            ...
                                                            if($v->NR_NOTA > 10){
                                                               echo $v->NR_NOTA{0}.'.'.$v->NR_NOTA{1};
                                                                ...
                                                                //echo number_format($v->NR_NOTA, 1, ',', '.');
                                                ...
                                                <td align="center">
                                                    ...
                                                    elseif ($row->NOTA > 0) {
                                                        $valor = $row->NOTA;
                                                        //echo number_format(str_replace(',', '.', $valor), 1, '.', '');
                                                        echo '<input class="text-center" value="'.str_replace(',', '.',$row->NOTA).'"  name="nota_' . $row->CD_ALU_DISC . '" placeholder="00.0" type="number" id="nota_' . $row->CD_ALU_DISC . '" place size="3" min="0.1" max="10" step=".1"/>';
                                                    } elseif ($row->NOTA == '0') {
                                                        $valor = $row->NOTA;
                                                        echo number_format(str_replace(',', '.', $valor), 1, '.', '');

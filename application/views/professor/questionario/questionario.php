    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="widget-body">
                ...
                if(is_null($bimestre)){
                    echo "Fora do período de lançamento de notas, contate a secretaria.";
                }
...
<? foreach ($divisao as $d) { ?>
                                        ...
                                        <div class="">
                                            ...
                                            <table class="table table-hover " style="background:#FFF">
                                                <thead>
                                                    <tr>
                                                        <td>Pergunta</td>
                                                        <td width="15%"><?=$bimestre?>º Bimestre</td>
                                                        <td width="5%">#</td>
                                                    </tr>
                                                </thead>
                                                <tbody>
            ...
            <div class="modal-footer">
                <a href="<?= SCL_RAIZ ?>impressao/questionario?token=<?= base64_encode($aluno)?>&qs=<?=$questionario?>&bimestre=<?= $bimestre?>" class="btn btn-info" target="_blank"><i class="fa fa-print"></i> Imprimir</a>
                <a class="btn btn-danger" href="<?=SCL_RAIZ?>professor/infantil/listar_turma?turma=<?=$turma?>&bimestre=<?= $bimestre?>"><i class="fa fa-rotate-left"></i> Fechar</a>
            </div>
        </div>
    </div>
</div>

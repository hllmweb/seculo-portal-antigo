<?php $this->load->view('layout/header-flex'); ?>
<div id="content">
    <div class="row">
        <div class="col-xs-12">
            <?php
                        ...
                        if (count($grade) > 0) {
                            foreach ($grade as $row) {
                                ...
                                <tr class="text-success">
                                    ...
                                    <td width="10%">
                                        <a class="btn btn-danger" href="<?= SCL_RAIZ ?>professor/infantil/listar_turma?turma=<?= $row['CD_TURMA'] ?>&bimestre=<?= $bimestre?>">
 ...
 <?php $this->load->view('layout/footer-flex'); ?>
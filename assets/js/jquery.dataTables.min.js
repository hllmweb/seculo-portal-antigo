    ...
    var L = function(h) {
        var j = function(e) {
            ...
            this.oApi = {
                        ...
                        _fnColumnOptions: m, 
                        _fnAddData: H, 
                        _fnCreateTr: ea, _fnGatherData: ua, _fnBuildHead: va, _fnDrawHead: W, _fnDraw: x, _fnReDraw: aa, _fnAjaxUpdate: wa, _fnAjaxParameters: Ea, _fnAjaxUpdateDraw: Fa, _fnServerParams: ka, _fnAddOptionsHtml: xa, _fnFeatureHtmlTable: Ba, _fnScrollDraw: La, _fnAdjustColumnSizing: k, _fnFeatureHtmlFilter: za, _fnFilterComplete: K, _fnFilterCustom: Ia, _fnFilterColumn: Ha,
        ...
        j.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0,
            ...
            fnRowCallback: null, fnServerData: function(e, j, m, k) {
                ...
                oPaginate: {
                    sFirst: "<i class='fa fa-step-backward middle btn btn-info btn-sm'></i>",
                    sLast: "<i class='fa fa-step-forward middle btn btn-info btn-sm'></i>",
                    sNext: "<i class='fa fa-caret-right btn btn-warning btn-sm'></i>",
                    sPrevious: "<i class='fa fa-caret-left btn btn-warning btn-sm'></i>"
                },
        ...
        h.extend(j.ext.oPagination, {two_button: {fnInit: function(e, j, m) {
                    ...
                    h(j).append('<a  tabindex="' + e.iTabIndex + '" class="' + l.sPageButton + " " + l.sPageFirst + '">' + k.sFirst + '</a><a  tabindex="' + e.iTabIndex + '" class="' + l.sPageButton + " " + l.sPagePrevious + '">' + k.sPrevious + '</a><spa"corte"></span><a tabindex="' + e.iTabIndex + '" class="' +

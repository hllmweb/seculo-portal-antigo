...
jQuery.imgAreaSelect = function(img, options) {
    ...
    function selectingMouseMove(event) {
        ...
        $a.css({left: (selection.x1 + imgOfs.left) + 'px', top: (selection.y1 + imgOfs.top) + 'px', width: Math.max(selection.width - options.borderWidth * 2, 0) + 'px', height: Math.max(selection.height - options.borderWidth * 2, 0) + 'px'});
    ...
    function movingMouseMove(event) {
        ...
        $a.css({left: x1 + 'px', top: y1 + 'px', width: Math.max(x2 - x1 - options.borderWidth * 2, 0) + 'px', height: Math.max(y2 - y1 - options.borderWidth * 2, 0) + 'px'});
        options.onSelectChange(img, selection);
    ...
    this.setOptions = function(newOptions) {
        ...
        if (newOptions.x1 != null) {
            ...
            $a.show().css({left: x1 + 'px', top: y1 + 'px', width: Math.max(x2 - x1 - options.borderWidth * 2, 0) + 'px', height: Math.max(y2 - y1 - options.borderWidth * 2, 0) + 'px'});
            options.onSelectChange(img, selection)
        }
        if (newOptions.hide)
            $a.hide();
    ...
    initOptions = {borderColor1: '#000', borderColor2: '#fff', borderWidth: 1, movable: true, resizable: true, selectionColor: '#fff', selectionOpacity: 0.2, onSelectStart: function() {
